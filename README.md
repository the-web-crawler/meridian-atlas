...
**Open the atlas:** [cdn.jsdelivr.net/gh/the-web-crawler/meridian-atlas@master/index.html](https://cdn.jsdelivr.net/gh/the-web-crawler/meridian-atlas@master/index.html)
...
- Search by name. Scroll, pinch, or the zoom buttons. Escape or the reset control clears the selection.
